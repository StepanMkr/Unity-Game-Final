...
public class EnemyAI : MonoBehaviour 
{
    ...
    private void ChasingTarget() => _navMeshAgent.SetDestination(Player.Instance.transform.position);

    public float GetRoamingAnimationSpeed() => _navMeshAgent.speed / _roamingSpeed;
    ...
    private Vector3 GetRoamingPosition() 
        => _startingPosition + Utils.GetRandomDir() * UnityEngine.Random.Range(_roamimgDistanceMin, _roamingDistanceMax);
