...
public class Sword : MonoBehaviour 
{
    ...
    private void Awake() => _polygonCollider2D = GetComponent<PolygonCollider2D>();

    private void Start() => AttackColliderTurnOff();
    ...
    private void AttackColliderTurnOn() => _polygonCollider2D.enabled = true;
